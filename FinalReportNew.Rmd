...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.width=5.5, fig.asp=0.618}
ols_model = modB
std_resid = rstandard(ols_model)
...
```{r p5y, echo=FALSE, message=FALSE, warning=FALSE, fig.width=5.5, fig.asp=0.618}
...
```{r p5z, fig.width=5, fig.asp=0.618, echo=FALSE}
...
```{r p5aa, fig.width=5, fig.asp=0.618, echo=FALSE}
std_resid_plt
```
...
```{r p6, echo = FALSE, warning = FALSE, message=FALSE, fig.width=6, fig.asp=0.618}
